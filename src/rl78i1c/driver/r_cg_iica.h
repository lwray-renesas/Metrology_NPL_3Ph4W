...
#define _08_IICA_LOW_WIDTH                            (0x08U) /* set the low-level width (tLOW) of the SCLA0 pin signal */
#define _08_IICA_HIGH_WIDTH                           (0x08U) /* set the high-level width of the SCLA0 pin signal */
#define _10_IICA_LOW_WIDTH                            (0x10U) /* set the low-level width (tLOW) of the SCLA0 pin signal */

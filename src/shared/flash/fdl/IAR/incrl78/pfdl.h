...
/*  Return:       PFDL status                                                                                     */
/* ---------------------------------------------------------------------------------------------------------------*/
extern __far_func pfdl_status_t PFDL_Open(pfdl_descriptor_t __near * descriptor_pstr);
...
/* ---------------------------------------------------------------------------------------------------------------*/
extern __far_func pfdl_status_t PFDL_Execute(pfdl_request_t __near * request_pstr);

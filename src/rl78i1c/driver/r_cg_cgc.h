...
Macro definitions
***********************************************************************************************************************/
#define CGC_FIHWAITTIME                        (520U)     /* change the waiting time according to the system */
#define CGC_FIMWAITTIME                        (32U)      /* change the waiting time according to the system */
#define CGC_FPLLWAITTIME                       (320U)     /* change the waiting time according to the system */
#define CGC_SUBWAITTIME                        (1440U)    /* change the waiting time according to the system */

...
void R_UART1_Create(void)
{
    ...
    SCR02 = _0004_SCR02_DEFAULT_VALUE | _8000_SAU_TRANSMISSION | _0000_SAU_TIMING_1 | _0000_SAU_INTSRE_MASK |
            _0200_SAU_PARITY_EVEN | _0080_SAU_LSB | _0010_SAU_STOP_1 | _0002_SAU_LENGTH_7;
...
{
    ST0 |= _0001_SAUm_CH0_STOP_TRG_ON;
    ...
    SCR00 = _0004_SCR00_DEFAULT_VALUE | _8000_SAU_TRANSMISSION | _3000_SAU_TIMING_4 | _0000_SAU_INTSRE_MASK |
            _0000_SAU_PARITY_NONE | _0000_SAU_MSB | _0000_SAU_STOP_NONE | _0003_SAU_LENGTH_8;
...
/***********************************************************************************************************************
* Function Name: R_UART1_Start_Reception
* Description  : This function starts the UART1 Reception only.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void R_UART1_Start_Reception(void)
{
    SS0 |= _0004_SAUm_CH2_START_TRG_ON;
    SRIF1 = 0U;     /* clear INTSR0 interrupt flag */
    SRMK1 = 0U;     /* enable INTSR0 interrupt */
}

/***********************************************************************************************************************
* Function Name: R_UART1_Stop_Reception
* Description  : This function stops the UART1 Reception only.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void R_UART1_Stop_Reception(void)
{
    ...
    ST0 |= _0004_SAUm_CH2_STOP_TRG_ON;
    SRIF1 = 0U;     /* clear INTSR0 interrupt flag */
}
/* End user code. Do not edit comment generated here */
